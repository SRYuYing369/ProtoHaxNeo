...
class GameSession : MinecraftRelayPacketListener {
	...
	var movementMode : AuthoritativeMovementMode? = null
    ...
    companion object {
		...
		const val COLORED_NAME = "§9§lProtoHaxNeo§r"
		const val CORE = "ProtoHaxNeo - Release [Based on ProtoHax]"
		const val CORE_VERSION = "Release 1.0.0"
    }
}
